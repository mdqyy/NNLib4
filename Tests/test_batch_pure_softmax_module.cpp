...
BOOST_AUTO_TEST_CASE(TestBatchPureSoftmaxModule)
{
	...
	float expected_output[] = {0.2f, 0.5f, 5.0f/6, 4.0f/7, 0.8f, 0.5f, 1.0f/6, 3.0f/7};
	
	BatchPureSoftmaxModule<float> a("module1");
...
BOOST_AUTO_TEST_CASE(TestBatchPureSoftmaxModuleGradient)
{
	...
	std::shared_ptr< Module<double> > m3(new BatchPureSoftmaxModule<double>("module3"));
