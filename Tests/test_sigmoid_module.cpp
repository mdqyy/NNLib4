...
BOOST_AUTO_TEST_CASE(TestSigmoidModule)
{
	...
	float derivative_expected_output[] = {0,0,0.1437f ,0.0925f , 0.0529f ,   0.0125f  ,  0.0174f  ,  0.0925f  ,  0.1437f  ,  0.0430f, 0, 0};
...
BOOST_AUTO_TEST_CASE(TestSigmoidGradient)
{
